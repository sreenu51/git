...
static struct cmdname_help command_list[] = {
	...
	{ "git-archimport", N_("Import an Arch repository into Git"), 0 | CAT_foreignscminterface },
	...
	{ "git-cherry", N_("Find commits yet to be applied to upstream"), 0 | CAT_ancillaryinterrogators | CAT_complete },
	...
	{ "git-get-tar-commit-id", N_("Extract commit ID from an archive created using git-archive"), 0 | CAT_ancillaryinterrogators },
	...
	{ "git-rev-parse", N_("Pick out and massage parameters"), 0 | CAT_ancillaryinterrogators },
